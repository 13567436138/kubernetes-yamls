...
public class MhDruidDataSource extends  DruidDataSource implements ApplicationContextAware {
    public static Map<String, String> concurrentHashMap = new ConcurrentHashMap<String, String>();
//    static Map<String, String> smallMap = new ConcurrentHashMap<String, String>();

    private final static Log LOG                       = LogFactory.getLog(MhDruidDataSource.class);
    ...
    private MhDruidDataSource.DestroyTask destroyTask;

    private volatile Future<?> createSchedulerFuture;

    private MhDruidDataSource.CreateConnectionThread createConnectionThread;
    private MhDruidDataSource.DestroyConnectionThread destroyConnectionThread;
    private MhDruidDataSource.LogStatsThread logStatsThread;
    ...
    protected static final AtomicLongFieldUpdater<MhDruidDataSource> recycleErrorCountUpdater
            = AtomicLongFieldUpdater.newUpdater(MhDruidDataSource.class, "recycleErrorCount");
    protected static final AtomicLongFieldUpdater<MhDruidDataSource> connectErrorCountUpdater
            = AtomicLongFieldUpdater.newUpdater(MhDruidDataSource.class, "connectErrorCount");
    protected static final AtomicLongFieldUpdater<MhDruidDataSource> resetCountUpdater
            = AtomicLongFieldUpdater.newUpdater(MhDruidDataSource.class, "resetCount");

    public MhDruidDataSource(){
        this(false);
    }

    public MhDruidDataSource(boolean fairLock){
        super(fairLock);
        ...
        try {
            ...
            if (createScheduler != null) {
                for (int i = 0; i < initialSize; ++i) {
                    createTaskCount++;
                    MhDruidDataSource.CreateConnectionTask task = new MhDruidDataSource.CreateConnectionTask(true);
    ...
    private void createAndLogThread() {
        ...
        logStatsThread = new MhDruidDataSource.LogStatsThread(threadName);
    ...
    protected void createAndStartDestroyThread() {
        destroyTask = new MhDruidDataSource.DestroyTask();
        ...
        destroyConnectionThread = new MhDruidDataSource.DestroyConnectionThread(threadName);
    ...
    protected void createAndStartCreatorThread() {
        if (createScheduler == null) {
            ...
            createConnectionThread = new MhDruidDataSource.CreateConnectionThread(threadName);
    ...
    public PooledConnection getPooledConnection(String user, String password) throws SQLException {
        throw new UnsupportedOperationException("Not supported by MhDruidDataSource");
    }
        ...
        for (boolean createDirect = false;;) {
            if (createDirect) {
                if (creatingCountUpdater.compareAndSet(this, 0, 1)) {
                    PhysicalConnectionInfo pyConnInfo = MhDruidDataSource.this.createPhysicalConnection();
...
//    }
     ...
     */
    public void close() {
        System.out.print("guanbi  shu  ju ku ");
        lock.lock();
        try {
            if (this.closed) {
                return;
    ...
    public void registerMbean() {
        if (!mbeanRegistered) {
            AccessController.doPrivileged(new PrivilegedAction<Object>() {
                ...
                @Override
                public Object run() {
                    ObjectName objectName = DruidDataSourceStatManager.addDataSource(MhDruidDataSource.this,
                            MhDruidDataSource.this.name);

                    MhDruidDataSource.this.setObjectName(objectName);
                    MhDruidDataSource.this.mbeanRegistered = true;
    ...
    public void unregisterMbean() {
        if (mbeanRegistered) {
            AccessController.doPrivileged(new PrivilegedAction<Object>() {
                ...
                @Override
                public Object run() {
                    DruidDataSourceStatManager.removeDataSource(MhDruidDataSource.this);
                    MhDruidDataSource.this.mbeanRegistered = false;
                    return null;
                }
            });
        }
    ...
    protected boolean put(PhysicalConnectionInfo physicalConnectionInfo) {
        ...
        try {
            holder = new DruidConnectionHolder(MhDruidDataSource.this, physicalConnectionInfo);
        } catch (SQLException ex) {
            lock.lock();
            try {
                if (createScheduler != null) {
    ...
    public class CreateConnectionThread extends Thread {
        ...
        public void run() {
            ...
            for (;;) {
                ...
                long discardCount = MhDruidDataSource.this.discardCount;
                ...
                try {
                    ...
                    context.publishEvent(new DataSourceLinkErrorEvent(this,MhDruidDataSource.this.getName(),
                            MhDruidDataSource.this.getGroupId(),MhDruidDataSource.this.getDataId()));
//                      context.publishEvent(new DataSoureEvent(jdbcUrl ));
    ...
    public MhDruidDataSource cloneDruidDataSource() {
        MhDruidDataSource x = new MhDruidDataSource();
    ...
    private void emptySignal() {
        ...
        createTaskCount++;
        MhDruidDataSource.CreateConnectionTask task = new MhDruidDataSource.CreateConnectionTask();
        this.createSchedulerFuture = createScheduler.submit(task);
    }
    ...
    public ObjectName preRegister(MBeanServer server, ObjectName name) throws Exception {
        if (server != null) {
            try {
                ...
                LOG.warn("MhDruidDataSource preRegister error", ex);
            }
        }
        return name;
    }
